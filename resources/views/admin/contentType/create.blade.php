...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Content Type Details</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                @if(!empty($category))
                    {!! Form::model($category,["files"=>true,"method"=>"PATCH","class"=>"form-horizontal","action"=> ['Admin\ContentTypeController@update',$category->id]]) !!}
                @else
                    {!! Form::open(["class"=>"form-horizontal","url"=> url('admin/contentType'),"files"=> true]) !!}
                @endif
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        @include('admin.contentType._form')
                    </div>
