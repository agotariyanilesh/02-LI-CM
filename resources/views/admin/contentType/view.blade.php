...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Content Type Management</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Content Type List</h3>
                        <div class="pull-right">
                            <a href="{{ url('admin/contentType/create') }}" class="btn btn-primary">Add Content Type</a>
                        </div>
                    </div>
                    <div class="box-body">
            ...
            $(document).on('click', '#action', function () {
                ...
                swal({
                    ...
                    function () {
                        $.ajax({
                            type: "post",
                            url: "{{ url('admin/contentType') }}/" + id + "/edit",
                            data: {_token: token},
                            beforeSend: function () {
                                //$('#wait').html("Wait for checking");
                            },
             ...
             $("body").on("change", ".chk_status", function () {
                ...
                $.ajax({
                    type: "PUT",
                    url: '{{ url('admin/contentType') }}/' + row_id ,
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "id": row_id,
                        "status": status,
