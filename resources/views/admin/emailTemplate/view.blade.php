                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <a href="{{ url('admin/email/create') }}" class="btn btn-primary">Add Email Template</a>
                        </div>
                    </div>
                    <div class="box-body">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var otable = $('#category').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{!! url('admin/email') !!}",
                columns: [
                    {data: "constant",name:'constant'},
