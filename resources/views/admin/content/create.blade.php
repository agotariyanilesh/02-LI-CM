...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                @if(!empty($category))
                    {!! Form::model($category,["files"=>true,"method"=>"PATCH","class"=>"form-horizontal","action"=> ['Admin\ContentController@update',$category->id]]) !!}
                @else
                    {!! Form::open(["class"=>"form-horizontal","url"=> url('admin/content'),"files"=> true]) !!}
                @endif
                ...
                <div class="box">
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-sm-10">
                            ...
                            <a href="{{ url('admin/content') }}" class="btn btn-danger btn-flat">Cancel</a>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
